...
export default class PathComponent extends LightningElement {
    ...
    connectedCallback() {
        ...
        console.log('Object Api Name is '+this.objectApiName+' And Field Api Name is '+this.fieldApiName);
        console.log(fields);
        if(this.recordTypeName){
            fields.push(this.objectApiName+'.RecordTypeId');
        }
        console.log('Value in Values '+this.values);
        if(this.values){
            ...
            for(let i=0; i<allValues.length; i++){
                ...
                console.log('Label '+allValues[i] +'Value '+allValues[i]);
            }
        }else{
    ...
    getfieldValue({error, data}){
        ...
        console.log('mujhe mat roko'+typeof data);
        if(data){
            console.log('mujhe mat roko'+typeof data);
